	...
	class USA {
		...
		class cia
		{
			...
			class SENIOR
			{
				...
				// commander = "SENIOR";
				// commanderRank = "Major";
				insignia = __EVAL(getMissionPath "img\cia_insignia.paa");
				text = "CIA Operative - SENIOR";
				textShort = "CIA - SENIOR";
				description = "SENIOR is the callsign for our CIA contact in the region, and will be running the interrogation of Fahim al-Arshad.";
			};
		};
	}
